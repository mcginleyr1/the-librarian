...
config :librarian, LibrarianWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "vRD4LqOzJpAwol3bgm0Mirp6ratyvJnOdpWcfgG8ZupvE8AkzffrPJ1+62TrRtge",
  watchers: [
...
config :librarian, LibrarianWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/librarian_web/router\.ex$"E,
      ~r"lib/librarian_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :librarian, dev_routes: true
